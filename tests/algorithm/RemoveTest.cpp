...
int main() {
...

    {
        ...
        simd_stl_assert((v == std::vector<int>{1, 2, 3}));
    }
...

    {
        ...
        simd_stl_assert(std::equal(v1.begin(), it1, v2.begin()));
    }

    {
        ...
        simd_stl_assert(std::equal(v.begin(), it1, v_std.begin()));
    }
 ...
 
    {
        ...
        simd_stl_assert((v == std::vector<int>{1, 3, 4}));
        simd_stl_assert(std::none_of(v.begin(), v.end(), [](int x) { return x == 2; }));
    }
...

    {
        ...
        simd_stl_assert(std::none_of(v.begin(), v.end(), [](int x) { return x == 0; }));
        simd_stl_assert(v.size() == N - N / 10);
    }

    {
        ...
        simd_stl_assert(std::equal(v.begin(), new_end, expected.begin()));
    }

    {
        ...
        simd_stl_assert(new_end == v.begin());
    }

    {
        ...
        simd_stl_assert(new_end == v.end());
        simd_stl_assert(std::equal(v.begin(), v.end(), std::vector<int>{1, 2, 3}.begin()));
    }
...

    {
        ...
        simd_stl_assert(std::equal(v.begin(), new_end, expected.begin(), [](const Item& a, const Item& b) {
