...
template <
    ...
    class _Predicate_>
simd_stl_nodiscard simd_stl_constexpr_cxx20 simd_stl_always_inline bool all_of(
...
{
    return simd_stl::algorithm::all_of(first, last, type_traits::passFunction(predicate));
}
