...
template <class _VectorType_, std::enable_if_t<_Is_valid_basic_simd_v<_VectorType_> || _Is_intrin_type_v<_VectorType_>, int> = 0>
__simd_nodiscard_inline _Unwrapped_vector_type<_VectorType_> _SimdUnwrap(_VectorType_ _Vector) noexcept;

template <class _MaskType_, std::enable_if_t<_Is_valid_basic_simd_v<_MaskType_> || _Is_intrin_type_v<_MaskType_> || std::is_integral_v<_MaskType_>, int> = 0>
...
__simd_nodiscard_inline _Rebind_vector_element_type<_ToType_, _FromType_> simd_cast(_FromType_ _From) noexcept;
...
__simd_nodiscard_inline _Rebind_vector_generation_type<_ToSimdGeneration_,
...
template <
    ...
    class               _Type_,
    class               _MaskType_>
__simd_nodiscard_inline _Make_tail_mask_return_type<simd<_SimdGeneration_, _Type_,
