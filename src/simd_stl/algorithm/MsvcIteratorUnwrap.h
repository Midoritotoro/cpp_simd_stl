...
template <class _Iterator_>
simd_stl_nodiscard constexpr decltype(auto) __unwrap_unverified_iterator(_Iterator_&& __iterator) 
...
simd_stl_nodiscard constexpr decltype(auto) __unwrap_iterator_offset(
...
template <
    class _Iterator_, 
    class _DifferenceType_>
simd_stl_nodiscard constexpr decltype(auto) __unwrap_iterator_bytes_offset(
    _Iterator_&&            __iterator,
