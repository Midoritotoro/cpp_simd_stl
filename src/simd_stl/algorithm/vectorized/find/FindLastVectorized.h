...
simd_stl_always_inline const _Type_* __find_last_scalar(
    const void* __first,
    const void* __last,
...
struct __find_last_vectorized_internal {
    ...
    simd_stl_always_inline const _ValueType* operator()(
...
template <class _Type_>
simd_stl_always_inline _Type_* __find_last_vectorized(
    const void* __first,
    const void* __last,
    _Type_      __value) noexcept
{
