...
simd_stl_always_inline std::pair<_Type_, _Type_> __minmax_scalar(
    const void* __first,
...
struct __minmax_vectorized_internal {
    ...
    simd_stl_always_inline std::pair<_ValueType, _ValueType> operator()(
...
template <class _Type_>
simd_stl_always_inline std::pair<_Type_, _Type_> __minmax_vectorized(
    const void* __first,
    const void* __last) noexcept
{
