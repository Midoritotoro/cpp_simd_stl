...
public:
    ...
    simd_stl_declare_const_function simd_stl_always_inline static auto Substract(
        const __m128i left,
    ...
    template <size_t typeSize>
    simd_stl_declare_const_function simd_stl_always_inline static size_t Reduce(const __m128i value) noexcept {
        static_assert(
            typeSize == 1 || typeSize == 2 || typeSize == 4 || typeSize == 8,
...
public:
    ...
    template <size_t typeSize>
    simd_stl_declare_const_function simd_stl_always_inline static size_t Reduce(__m256i value) noexcept {
        static_assert(
            typeSize == 1 || typeSize == 2 || typeSize == 4 || typeSize == 8,
...
public:
    ...
    template <size_t typeSize>
    simd_stl_declare_const_function simd_stl_always_inline static size_t Reduce(const __m512i value) noexcept {
        static_assert(
            typeSize == 1 || typeSize == 2 || typeSize == 4 || typeSize == 8,
            "base::algorithm::CountTraits<arch::CpuFeature::AVX2>::Reduce: Unsupported typeSize size");
