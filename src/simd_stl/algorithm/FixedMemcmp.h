...
simd_stl_declare_const_function simd_stl_always_inline bool __always_true(
    const void*,
    const void*) noexcept
{
    return true;
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp1(
    const void* __first,
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp2(
    const void* __first,
    const void* __second) noexcept
{
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp3(
    const void* __first,
    const void* __second) noexcept
{
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp4(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_loaded   = *reinterpret_cast<const uint32*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp5(
    const void* __first,
    const void* __second) noexcept
{
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp6(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_loaded   = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp7(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_loaded   = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp8(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_loaded   = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp9(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_loaded   = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp10(
    const void* __first,
    const void* __second) noexcept
{
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp11(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_qword    = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_declare_const_function simd_stl_always_inline bool __memcmp12(
    const void* __first,
    const void* __second) noexcept
{
    const auto __first_qword    = *reinterpret_cast<const uint64*>(__first);
...
simd_stl_always_inline bool __is_all_bits_zero(const _Type_& __value) noexcept {
