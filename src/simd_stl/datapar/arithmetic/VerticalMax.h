...
template <class _DesiredType_> struct _Simd_vertical_max<arch::ISA::SSE41, 128, _DesiredType_> : _Simd_vertical_max<arch::ISA::SSSE3, 128, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_vertical_max<arch::ISA::AVX512BW, 512, _DesiredType_> : _Simd_vertical_max<arch::ISA::AVX512F, 512, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_vertical_max<arch::ISA::AVX512VLF, 256, _DesiredType_> : _Simd_vertical_max<arch::ISA::AVX2, 256, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_vertical_max<arch::ISA::AVX512VLF, 128, _DesiredType_> : _Simd_vertical_max<arch::ISA::AVX2, 128, _DesiredType_> {};
