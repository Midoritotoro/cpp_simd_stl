...
template <
    ...
    class	    _Type_,
    uint32      _Width_>
simd_stl_always_inline bool simd<_ISA_, _Type_, _Width_>::is_supported() noexcept {
...
template <
    ...
    class	    _Type_,
    uint32      _Width_>
simd_stl_always_inline simd<_ISA_, _Type_, _Width_>& 
...
template <
    ...
    class	    _Type_,
    uint32      _Width_>
simd_stl_always_inline _Type_ simd<_ISA_, _Type_, _Width_>::extract(size_type __index) const noexcept
{
...
template <
    ...
    class	    _Type_,
    uint32      _Width_>
simd_stl_always_inline void simd<_ISA_, _Type_, _Width_>::insert(
...
simd_stl_always_inline simd_mask<_ISA_, _DesiredType_, _Width_>
...
template <
    ...
    uint32      _Width_>
template <typename _DesiredType_>
simd_stl_always_inline auto simd<_ISA_, _Type_, _Width_>::to_index_mask() const noexcept {
...
template <
    ...
    class	    _Type_,
    uint32      _Width_>
simd_stl_always_inline simd<_ISA_, _Type_, _Width_>::vector_type
