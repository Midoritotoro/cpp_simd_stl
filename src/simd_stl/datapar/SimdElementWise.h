...
#include <src/simd_stl/datapar/SimdIntegralTypesCheck.h>
#include <src/simd_stl/datapar/SimdConvert.h>

#include <simd_stl/datapar/BasicSimdShuffleMask.h>
#include <src/simd_stl/datapar/ShuffleTables.h>
...
template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMIVLBW, xmm128> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBW, xmm128>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMI2VLBW, xmm128> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBW, xmm128>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMIVLBWDQ, xmm128> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBWDQ, xmm128>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMI2VLBWDQ, xmm128> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBWDQ, xmm128>
{};
...
template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMIVLBW, ymm256> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBW, ymm256>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMI2VLBW, ymm256> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBW, ymm256>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMIVLBWDQ, ymm256> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBWDQ, ymm256>
{};

template <>
class __simd_element_wise<arch::CpuFeature::AVX512VBMI2VLBWDQ, ymm256> :
	public __simd_element_wise<arch::CpuFeature::AVX512VLBWDQ, ymm256>
{};
...
#include <src/simd_stl/datapar/SimdElementWise.inl>