...
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::SSE2, xmm128>::__compress(
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::SSSE3, xmm128>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
    return __compress<_DesiredType_>(__simd_to_mask<__generation, __register_policy, _DesiredType_>(__vector, __mask));
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::SSE41, xmm128>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
    return __compress<_DesiredType_>(__simd_to_mask<__generation, __register_policy, _DesiredType_>(__vector, __mask));
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::AVX2, ymm256>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::AVX512F, zmm512>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
    return __compress<_DesiredType_>(__vector, __simd_to_mask<__generation, __register_policy, _DesiredType_>(__mask));
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::AVX512VLF, ymm256>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
    return __compress<_DesiredType_>(__vector, __simd_to_mask<__generation, __register_policy, _DesiredType_>(__mask));
    ...
    __simd_mask_type<_DesiredType_> __mask) noexcept
{
    ...
    if constexpr (sizeof(_DesiredType_) == 8) {
        ...
        return __simd_compress<arch::ISA::AVX2, __register_policy, _DesiredType_>(__vector, __mask);
    }
}
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline std::pair<int32, _VectorType_> __simd_element_wise<arch::ISA::AVX512VLF, xmm128>::__compress(
    _VectorType_    __vector,
    _VectorType_    __mask) noexcept
{
    return __compress<_DesiredType_>(__vector, __simd_to_mask<__generation, __register_policy, _DesiredType_>(__mask));
    ...
    __simd_mask_type<_DesiredType_> __mask) noexcept
{
    ...
    if constexpr (sizeof(_DesiredType_) == 8) {
        ...
        return __simd_compress<arch::ISA::SSE42, __register_policy, _DesiredType_>(__vector, __mask);
    }
}
