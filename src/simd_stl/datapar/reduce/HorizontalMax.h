...
#include <src/simd_stl/datapar/arithmetic/VerticalMax.h>
#include <src/simd_stl/datapar/shuffle/BroadcastZeros.h>

#include <src/simd_stl/datapar/reduce/Fold.h>
...
struct _Simd_vertical_max_wrapper {
	...
	simd_stl_always_inline _IntrinType_ operator()(
		_IntrinType_ __left,
...
struct _Simd_horizontal_max<arch::ISA::SSE2, 128, _DesiredType_> {
	...
	simd_stl_nodiscard simd_stl_static_operator simd_stl_always_inline
		_DesiredType_ operator()(_IntrinType_ __vector) simd_stl_const_operator noexcept
	{
