...
template <class _DesiredType_> struct _Simd_to_index_mask<arch::ISA::AVX512BW, 512, _DesiredType_> : _Simd_to_index_mask<arch::ISA::AVX512F, 512, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_to_index_mask<arch::ISA::AVX512VLBW, 256, _DesiredType_> : _Simd_to_index_mask<arch::ISA::AVX512VLF, 256, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_to_index_mask<arch::ISA::AVX512VLBWDQ, 256, _DesiredType_> : _Simd_to_index_mask<arch::ISA::AVX512VLBW, 256, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_to_index_mask<arch::ISA::AVX512VLBW, 128, _DesiredType_> : _Simd_to_index_mask<arch::ISA::AVX512VLF, 128, _DesiredType_> {};
...
template <class _DesiredType_> struct _Simd_to_index_mask<arch::ISA::AVX512VLBWDQ, 128, _DesiredType_> : _Simd_to_index_mask<arch::ISA::AVX512VLBW, 128, _DesiredType_> {};
