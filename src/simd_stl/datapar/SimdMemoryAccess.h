...
#include <src/simd_stl/datapar/SimdElementWise.h>
#include <simd_stl/datapar/BasicSimdMask.h>

#include <src/simd_stl/algorithm/AdvanceBytes.h>
#include <src/simd_stl/datapar/SimdBroadcast.h>
...
template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMIVLBW, xmm128> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBW, xmm128>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMI2VLBW, xmm128> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBW, xmm128>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMIVLBWDQ, xmm128> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBWDQ, xmm128>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMI2VLBWDQ, xmm128> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBWDQ, xmm128>
{};
...
template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMIVLBW, ymm256> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBW, ymm256>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMI2VLBW, ymm256> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBW, ymm256>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMIVLBWDQ, ymm256> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBWDQ, ymm256>
{};

template <>
class __simd_memory_access<arch::CpuFeature::AVX512VBMI2VLBWDQ, ymm256> :
	public __simd_memory_access<arch::CpuFeature::AVX512VLBWDQ, ymm256>
{};
...
using __make_tail_mask_return_type_helper = std::conditional_t<__is_intrin_type_v<_ReturnType_>,
    simd<_BasicSimd_::__generation, typename _BasicSimd_::value_type, typename _BasicSimd_::policy_type>, 
    simd_mask<_BasicSimd_::__generation, typename _BasicSimd_::value_type, typename _BasicSimd_::policy_type>>;

template <class _BasicSimd_>
using __make_tail_mask_return_type = __make_tail_mask_return_type_helper<_BasicSimd_,
    type_traits::invoke_result_type<decltype(__simd_make_tail_mask<_BasicSimd_::__generation, typename _BasicSimd_::policy_type, typename _BasicSimd_::value_type>), uint32>>;

__SIMD_STL_DATAPAR_NAMESPACE_END

#include <src/simd_stl/datapar/SimdMemoryAccess.inl>