...
#include <src/simd_stl/datapar/shuffle/Broadcast.h>

#include <simd_stl/memory/PointerToIntegral.h>
#include <src/simd_stl/datapar/shuffle/InsertMask.h>
...
struct _Simd_extract<arch::ISA::SSE2, 128, _DesiredType_> {
    ...
    simd_stl_nodiscard simd_stl_static_operator simd_stl_always_inline _DesiredType_ operator()(
        _IntrinType_&   __vector,
        uint8			__index) simd_stl_const_operator noexcept
    {
