...
template <
 ...
 simd_stl_always_inline __simd_convert<arch::CpuFeature::SSE2, xmm128>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::SSE2, xmm128>::__to_mask(_VectorType_ __vector) noexcept
{
    if      constexpr (sizeof(_DesiredType_) == 8)
        return _mm_movemask_pd(__intrin_bitcast<__m128d>(__vector));

    else if constexpr (sizeof(_DesiredType_) == 4)
        return _mm_movemask_ps(__intrin_bitcast<__m128>(__vector));

    else if constexpr (sizeof(_DesiredType_) == 2)
        return _mm_movemask_epi8(_mm_packs_epi16(__intrin_bitcast<__m128i>(__vector), _mm_setzero_si128()));
    ...
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept
{
    ...
    if constexpr (__bits == 2) {
        ...
        const auto __broadcasted = _mm_set_epi8((__mask >> 15) & 1, (__mask >> 14) & 1, (__mask >> 13) & 1, (__mask >> 12) & 1,
            ...
            (__mask >> 6) & 1, (__mask >> 5) & 1, (__mask >> 4) & 1,
            (__mask >> 3) & 1, (__mask >> 2) & 1, (__mask >> 1) & 1, __mask & 1);
...
template <
    typename _VectorType_,
    typename _DesiredType_>
 simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::SSSE3, xmm128>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept 
{
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);
...
template <
    typename _DesiredType_,
    typename _VectorType_>
 simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX2, ymm256>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX2, ymm256>::__to_mask(_VectorType_ __vector) noexcept
{
    if      constexpr (sizeof(_DesiredType_) == 8) {
        return _mm256_movemask_pd(__intrin_bitcast<__m256d>(__vector));
    }
    else if constexpr (sizeof(_DesiredType_) == 4) {
        return _mm256_movemask_ps(__intrin_bitcast<__m256>(__vector));
    }
    else if constexpr (sizeof(_DesiredType_) == 2) {
        ...
        return _mm256_movemask_epi8(__shuffled);
    }
    else if constexpr (sizeof(_DesiredType_) == 1) {
...
template <
    typename _VectorType_,
    typename _DesiredType_>
 simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX2, ymm256>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept 
{
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);
...
template <
    typename _DesiredType_,
    typename _VectorType_>
 simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512F, zmm512>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512F, zmm512>::__to_mask(_VectorType_ __vector) noexcept
{
    ...
    if constexpr (__bits == 16) {
        ...
        const auto __high = __simd_to_mask<arch::CpuFeature::AVX2, ymm256, _DesiredType_>(
            _mm512_extractf64x4_pd(__intrin_bitcast<__m512d>(__vector), 1));
...
template <
    typename _DesiredType_,
    typename _VectorType_>
 simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512BW, zmm512>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512BW, zmm512>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);

    if constexpr (__bits == 64)
...
template <
    typename _VectorType_,
    typename _DesiredType_>
 simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512BW, zmm512>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
template <
    typename _DesiredType_,
    typename _VectorType_>
 simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512DQ, zmm512>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512DQ, zmm512>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
template <
    typename _VectorType_,
    typename _DesiredType_>
 simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512DQ, zmm512>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept 
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLBW, ymm256>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLBW, ymm256>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512VLBW, ymm256>
    ::__to_vector(__simd_mask_type<_DesiredType_> _Mask) noexcept 
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
    constexpr auto _Bits = sizeof(_VectorType_) / sizeof(_DesiredType_);

    if constexpr (_Bits == 32)
        return __intrin_bitcast<_VectorType_>(_mm256_movm_epi8(_Mask));
    else if constexpr (_Bits == 16)
        return __intrin_bitcast<_VectorType_>(_mm256_movm_epi16(_Mask));
    else
        return __simd_to_vector<arch::CpuFeature::AVX2, __register_policy, _DesiredType_>(_Mask);
}

template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLDQ, ymm256>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLDQ, ymm256>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
template <
    typename _VectorType_,
    typename _DesiredType_>
simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512VLDQ, ymm256>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept 
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLBW, xmm128>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLBW, xmm128>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLDQ, xmm128>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLDQ, xmm128>::__to_mask(_VectorType_ __vector) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
...
template <
    typename _VectorType_,
    typename _DesiredType_>
simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512VLDQ, xmm128>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept
{
    using _MaskType = __simd_mask_type<_DesiredType_>;
    constexpr auto __bits = sizeof(_VectorType_) / sizeof(_DesiredType_);
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLBWDQ, xmm128>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLBWDQ, xmm128>::__to_mask(_VectorType_ __vector) noexcept
{
...
template <
    typename _VectorType_,
    typename _DesiredType_>
simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512VLBWDQ, xmm128>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept
{
    if constexpr (sizeof(_DesiredType_) <= 2)
...
template <
    typename _DesiredType_,
    typename _VectorType_>
simd_stl_always_inline __simd_convert<arch::CpuFeature::AVX512VLBWDQ, ymm256>::__simd_mask_type<_DesiredType_> 
    __simd_convert<arch::CpuFeature::AVX512VLBWDQ, ymm256>::__to_mask(_VectorType_ __vector) noexcept
{
    if constexpr (sizeof(_DesiredType_) <= 2)
        return __simd_to_mask<arch::CpuFeature::AVX512VLBW, __register_policy, _DesiredType_>(__vector);
    else
...
template <
    typename _VectorType_,
    typename _DesiredType_>
simd_stl_always_inline _VectorType_ __simd_convert<arch::CpuFeature::AVX512VLBWDQ, ymm256>
    ::__to_vector(__simd_mask_type<_DesiredType_> __mask) noexcept
{
    if constexpr (sizeof(_DesiredType_) <= 2)
        return __simd_to_vector<arch::CpuFeature::AVX512VLBW, __register_policy, _DesiredType_>(__mask);
